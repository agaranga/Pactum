    ...
    public PromptService()
    {
        ...
        _prompts.Add(new PromptTemplate
        {
            ...
            Text = """
                ...
                8. ОТ 2 ДО 4 ЛЮДЕЙ В КАДРЕ ВСЕГО. Это жёсткое ограничение. Не больше 4 людей.
                   Каждое упоминание людей в промпте должно содержать ТОЧНОЕ ЧИСЛО прописью: "two bakers in white aprons", "one customer browsing shelves". НЕ писать "bakers" или "customers" во множественном числе без числа — модель сгенерирует толпу.
                   В конце промпта ОБЯЗАТЕЛЬНО добавь явную фразу типа: "exactly three people in the scene total" или "only 2 people total".
                   Дополнительно добавь в конец: "clean detailed faces, no extra people in background".
