    ...
    public PromptService()
    {
        ...
        _prompts.Add(new PromptTemplate
        {
            ...
            Text = """
                ...
                8. Ровно 2 человека в кадре: 1 сотрудник + 1 клиент. Не больше. Опиши их действия. Чем меньше людей — тем чище лица. Не используй обобщения вроде "staff" или "customers" во множественном числе.
